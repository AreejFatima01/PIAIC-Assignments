...
const favoritePizzas: string[] = ["Pepperoni", "Fajita", "Cheese lover"];
...
console.log(
  "I really love pizza! There's so much variety to explore, from classic combinations to unique gourmet options."
);
